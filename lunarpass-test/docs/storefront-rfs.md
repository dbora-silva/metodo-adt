...
Documento funcional e de negócio do Storefront (jornada do viajante), abrangendo as seguintes funcionalidades: Busca de Missões, Mapa de Assentos, Passageiros, Pagamento e Emissão do Ticket.

## 2. Perfis de Usuário

- **Viajante**: único perfil de usuário identificado na documentação, presente como ator em todas as histórias de usuário (busca de missões, seleção de assentos, cadastro de passageiros, pagamento e emissão do ticket).

## 3. Funcionalidades

### 3.1 Busca de Missões

#### História de Usuário
Como viajante, quero buscar e comparar missões por base lunar e por data de lançamento, para escolher a viagem mais adequada ao meu destino e à minha disponibilidade.
...
### 3.2 Mapa de Assentos

#### História de Usuário
Como viajante, quero visualizar a cabine do foguete e escolher os assentos da minha viagem, para garantir os lugares desejados para mim e meus acompanhantes.
...
#### História de Usuário
Como viajante, quero informar os dados dos passageiros de cada assento reservado, para que as passagens sejam emitidas em nome das pessoas que vão viajar.
...
#### História de Usuário
Como viajante, quero pagar minha reserva com cartão de crédito e receber retorno imediato sobre o resultado, para concluir a compra da viagem com segurança e clareza.
...
### 3.5 Emissão do Ticket

#### História de Usuário
Como viajante, quero receber a confirmação da reserva com o código, as passagens e o comprovante do valor pago, para ter a garantia da compra e as informações necessárias para o embarque.
